...
public class DeleteCreditCard {
   ...
   public static void DeleteCreditCardMain() {
   ...
   try{
      ...
      String sql = "SELECT * FROM Credit_card WHERE CUSTOMERID ="+custId;
    ...
    String creditnum = keyboard.next();
      sql = "DELETE FROM Credit_card WHERE CREDITNUMBER ="+creditnum;
