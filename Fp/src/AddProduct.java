...
public class AddProduct {
   ...
   public static void AddProductMain() {
...
//    keyboard.close();
   ...
   try{
      ...
      String sql="SELECT prodID_seq.nextval FROM dual";
      ResultSet rs = stmt.executeQuery(sql);
      rs.next();
      int prodId = rs.getInt("NEXTVAL");
      sql = "INSERT INTO PRODUCT VALUES("+prodId+",'"+prodCat+"','"+prodName+"',"+prodSize+")";
